        ...
        internal static async void BotOnMessage(object sender, MessageEventArgs e)
        {
                ...
                switch (e.Message.Text)
                {
                    case "/start":
                        await Bot.SendTextMessageAsync(
                            ...
                            text: "Use /help to see what this bot can do.");
                        break;
                    
                    case "/help":
                        await Bot.SendTextMessageAsync(
                            chatId: e.Message.Chat,
                            text: "This bot is a Genshin Impact Wish Simulator that works only in the group chats. Feel free to add it to your chat (privacy mode is on so no spying on whatever conversations you may have).\n\nUse /wish command to make a wish. You can only wish once a day per chat. The timer resets at 9PM UTC.\nUse /inv command to see your inventory. Inventories are bound to the chats.\n\n/about - source code");
                        break;
                    
                    case "/about":
                        await Bot.SendTextMessageAsync(
                            chatId: e.Message.Chat,
                            text: "The source code is available on <a href=\"https://github.com/FrenzyYum/GenshinWishingBot\">GitHub</a>.",
            ...
            switch (msg)
            {
                ...
                case "/wish":
                    if (Wish.HasRolled(e.Message) == 1)
                    {
                        ...
                        await Bot.SendTextMessageAsync(
                            ...
                            text: $"You've already wished today! You can wish again in {hourDiff} hours and {minuteDiff} minutes.",
                            replyToMessageId: e.Message.MessageId);
                        return;
                    }
                ...
                case "/resetUser":
                    ...
                    await Bot.SendTextMessageAsync(
                        chatId: e.Message.Chat.Id,
                        text: $"Daily wish reset for {e.Message.ReplyToMessage.From.FirstName}!",
                        replyToMessageId: e.Message.MessageId);
                    break;
                ...
                case "/resetChat":
                    ...
                    await Bot.SendTextMessageAsync(
                        chatId: e.Message.Chat.Id,
                        text: $"Daily wish reset for everyone in {e.Message.Chat.Title}!",
                        replyToMessageId: e.Message.MessageId);
                    break;
            }
        }
